...
def handle_game(player1, player2):
    ...
    while not game_over:
        ...
        # Trimite tabla de joc actualizată separat
        board_state = format_board(board)
        current_player.send(f"TABLĂ\n{board_state}".encode())
        opponent.send(f"TABLĂ\n{board_state}".encode())
        ...
        try:
            ...
            current_player.send("Input invalid. Introdu un număr între 0 și 6: ".encode())
